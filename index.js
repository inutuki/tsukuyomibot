import { Client, GatewayIntentBits, Collection, REST, Routes, ChannelType, PermissionsBitField } from "discord.js";
import dotenv from "dotenv";
import fs from "fs";
import cron from "node-cron";
import { data as pingData, execute as pingExec } from "./commands/slash/ping.js";
import { data as omikujiData, execute as omikujiExec } from "./commands/slash/omikuji.js";
import { data as autoroleData, execute as autoroleExec } from "./commands/slash/auto.role.js";
import { data as autovcData, execute as autovcExec } from "./commands/slash/auto.vc.js";
import { data as rankData, execute as rankExec } from "./commands/slash/rank.js";
import { data as pluginData, execute as pluginExec } from "./commands/slash/plugin.js";
...
client.commands.set(omikujiData.name, { data: omikujiData, execute: omikujiExec });
client.commands.set(autoroleData.name, { data: autoroleData, execute: autoroleExec });
...
client.once("ready", async () => {
    ...
    // --- スケジュール登録 (日本時間) ---
    // --- 毎日 07:00 に公開 ---
    cron.schedule('0 7 * * *', () => updateChannelVisibility(true), { timezone: "Asia/Tokyo" });

    // --- 毎日 22:00 に非公開 ---
    cron.schedule('0 22 * * *', () => updateChannelVisibility(false), { timezone: "Asia/Tokyo" });

    console.log("スケジュールタスクを登録しました (07:00 公開 / 22:00 非公開)");
    */
